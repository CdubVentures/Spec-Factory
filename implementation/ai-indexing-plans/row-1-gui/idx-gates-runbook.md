...
1. `helper_files/<category>/_control_plane/field_rules_draft.json`
2. `helper_files/<category>/_generated/field_rules.json`
3. `helper_files/<category>/_generated/field_rules.runtime.json`
...
5. If values mismatch known workbook/key-navigator data, inspect field-rules payload used for run and consumer overrides (`consumers.idx`/`consumers.indexlab`).
