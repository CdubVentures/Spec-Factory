...
- workbook map save has server-side validation gate
...
- post-phase hardening completed for workbook-map preflight and conflict guard behavior
...
- studio save/compile path bypassing workbook-map validation
