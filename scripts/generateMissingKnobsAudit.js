...
const missingRows = [
  ...
  {
    key: 'serpTriageMaxUrls', defaultValue: '20', type: 'number',
    section: 'Scoring & Evidence', group: 'SERP Triage',
    description: 'Max URLs passed from SERP triage to the fetch queue per search round. Runtime copy of the convergence knob. Exists in both layers; convergence copy is rendered on Convergence tab.',
    priority: 'Low', category: 'Runtime (cross-layer)',
  },
  {
...
const summaryRows = [
  ...
  { metric: '', count: '', notes: '' },
  { metric: 'TOTAL NOT SURFACED IN GUI (Missing Knobs sheet)', count: 25, notes: 'All rows on the Missing Knobs sheet — these have no GUI control' },
  { metric: '', count: '', notes: '' },
  ...
  { metric: '  Legacy / Cross-Layer Duplicates', count: 3, notes: 'concurrency (legacy alias), dynamicFetchPolicyMap (legacy alias), serpTriageMaxUrls (convergence copy rendered)' },
