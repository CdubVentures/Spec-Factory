...
test('buildEvidenceReport populates from run data', () => {
  const runData = {
    ...
    settings_snapshot: { searchEngines: 'bing,google-proxy,duckduckgo', discoveryEnabled: true, preferHttpFetcher: true, dynamicCrawleeEnabled: true },
    scenario: 'A',
  ...
  assert.equal(report.searchEngines, 'bing,google-proxy,duckduckgo');
