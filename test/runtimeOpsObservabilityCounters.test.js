...
test('observability: slot reuse counter increments on sequential queries', async () => {
  ...
  assert.ok(obs.search_slot_reuse >= 2, `slot reuse count: ${obs.search_slot_reuse} (expected >= 2)`);
});
