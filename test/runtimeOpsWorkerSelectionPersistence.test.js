    ...
    stubs: {
      ...
      '@tanstack/react-query': `
        export function useQuery(options) {
          ...
          if (key === '["indexlab","runs"]') {
            return {
              data: {
                runs: [
                  { run_id: 'run-123', category: 'mouse', started_at: '2026-03-11T00:00:00.000Z', status: 'completed' },
                  { run_id: 'run-456', category: 'mouse', started_at: '2026-03-10T00:00:00.000Z', status: 'completed' },
                ],
              },
            };
          }
