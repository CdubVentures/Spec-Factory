...
# WHY: SearXNG's gen_gsa_useragent() sends Google Search App UAs that Google
# fingerprints and blocks with 403. Use real desktop Chrome UAs instead.
_CHROME_USER_AGENTS = [
...
def get_google_info(params: "OnlineParams", eng_traits: EngineTraits) -> dict[str, t.Any]:
    ...
    # WHY: Google rejects Accept: */* — real browsers send proper HTML accept.
    ret_val["headers"]["Accept"] = "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"
    ret_val["headers"]["Accept-Language"] = "en-US,en;q=0.9"
