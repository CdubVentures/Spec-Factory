    ...
    <div className="sf-surface-panel rounded-lg p-4 border sf-border-soft flex flex-col items-center gap-2.5">
      ...
      <div className="relative w-[110px] h-[110px]">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
          <div className="text-lg font-extrabold font-mono sf-text-primary leading-none">{modelCount}</div>
          <div className="text-[9px] sf-text-dim uppercase font-semibold tracking-[0.05em]">models</div>
        </div>
      </div>
