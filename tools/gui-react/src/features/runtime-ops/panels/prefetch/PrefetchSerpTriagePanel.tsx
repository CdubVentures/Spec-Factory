      ...
      <div className="flex flex-col gap-4 p-4 overflow-y-auto flex-1">
        ...
        <div className="flex flex-col items-center gap-3 py-12 text-center">
          ...
          {triageEnabledLive !== undefined && (
            <span className={`px-2 py-0.5 rounded-full sf-text-caption font-medium ${triageEnabledLive ? 'sf-chip-warning' : 'sf-chip-neutral'}`}>
              Runtime Mode: {triageEnabledLive ? 'LLM rerank' : 'Deterministic'}
            </span>
          )}
        </div>
      </div>
