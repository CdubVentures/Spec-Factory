...
export const LLM_PHASES: readonly LlmPhaseDefinition[] = [
  ...
  },
  {
    ...
    subtitle: 'Base Model',
    tip: 'Base Model shared with SERP Triage. Opt-in reasoning toggle overrides with shared Reasoning Model.',
    roles: ['triage'],
    sharedWith: ['serp-triage'],
  },
  {
    id: 'search-planner',
  ...
  },
  {
    ...
    label: 'SERP Triage',
    subtitle: 'Base Model',
    tip: 'Base Model shared with Brand Resolver. Opt-in reasoning toggle overrides with shared Reasoning Model.',
    roles: ['triage'],
