...
export function deriveIndexingRunStartParsedValues({
  ...
  return {
    ...
    parsedSearchGlobalRps: parseRuntimeInt(readValue('searchGlobalRps'), runtimeSettingsBaseline.searchGlobalRps),
    parsedSearchGlobalBurst: parseRuntimeInt(readValue('searchGlobalBurst'), runtimeSettingsBaseline.searchGlobalBurst),
    parsedSearchPerHostRps: parseRuntimeInt(readValue('searchPerHostRps'), runtimeSettingsBaseline.searchPerHostRps),
    parsedSearchPerHostBurst: parseRuntimeInt(readValue('searchPerHostBurst'), runtimeSettingsBaseline.searchPerHostBurst),
    ...
    parsedHelperActiveSyncLimit: parseRuntimeInt(readValue('helperActiveSyncLimit'), runtimeSettingsBaseline.helperActiveSyncLimit),
