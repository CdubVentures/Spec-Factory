...
export function buildIndexingRunStartPayload(
  ...
  const runtimePayload: StartIndexingRunPayloadRecord = {
    ...
    ...buildIndexingRunModelPayload({
      ...
      llmExtractFallbackModel: readString(s.llmExtractFallbackModel),
      llmValidateFallbackModel: readString(s.llmValidateFallbackModel),
      llmWriteFallbackModel: readString(s.llmWriteFallbackModel),
