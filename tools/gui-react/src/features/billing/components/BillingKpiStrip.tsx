...
export function BillingKpiStrip({ summary, isLoading }: BillingKpiStripProps) {
  if (isLoading) return <Spinner className="h-8 w-8 mx-auto mt-4" />;
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-px sf-border-default rounded-xl overflow-hidden">
