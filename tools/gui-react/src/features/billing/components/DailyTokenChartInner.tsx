...
const LEGEND = [
  { key: 'prompt',     label: 'Prompt',     color: 'var(--sf-tok-prompt)' },
  { key: 'usage',      label: 'Usage',      color: 'var(--sf-tok-usage)' },
  { key: 'completion', label: 'Output',     color: 'var(--sf-tok-completion)' },
  { key: 'cached',     label: 'Cached',     color: 'var(--sf-tok-cached)' },
] as const;
...
export default function DailyTokenChartInner({ data, isLoading, isStale }: DailyTokenChartProps) {
