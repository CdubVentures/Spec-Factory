...
const KEY_NAVIGATION_PATHS: Record<string, { section: string; key: string }> = {
  'contract.type': { section: 'Contract (Type, Shape, Unit)', key: 'Data Type' },
  'contract.shape': { section: 'Contract (Type, Shape, Unit)', key: 'Shape' },
  'contract.unit': { section: 'Contract (Type, Shape, Unit)', key: 'Unit' },
  'contract.range': { section: 'Contract (Type, Shape, Unit)', key: 'Range' },
  'contract.list_rules': { section: 'Contract (Type, Shape, Unit)', key: 'List Rules' },
  'contract.unknown_token': { section: 'Contract (Type, Shape, Unit)', key: 'Unknown Token' },
  'priority.required_level': { section: 'Priority & Effort', key: 'Required Level' },
  'priority.availability': { section: 'Priority & Effort', key: 'Availability' },
  'priority.difficulty': { section: 'Priority & Effort', key: 'Difficulty' },
  'priority.effort': { section: 'Priority & Effort', key: 'Effort' },
  'priority.block_publish_when_unk': { section: 'Priority & Effort', key: 'Block Publish When Unknown' },
  'ai_assist.mode': { section: 'AI Assist', key: 'Mode' },
  'ai_assist.model_strategy': { section: 'AI Assist', key: 'Model Strategy' },
  'ai_assist.max_tokens': { section: 'AI Assist', key: 'Max Tokens' },
  'ai_assist.reasoning_note': { section: 'AI Assist', key: 'Reasoning Note' },
  'parse.template': { section: 'Parse Rules', key: 'Parse Template' },
  'enum.policy': { section: 'Enum Policy', key: 'Policy' },
  'enum.source': { section: 'Enum Policy', key: 'Source' },
  'evidence.required': { section: 'Evidence Requirements', key: 'Evidence Required' },
  'evidence.min_evidence_refs': { section: 'Evidence Requirements', key: 'Min Evidence Refs' },
  'evidence.conflict_policy': { section: 'Evidence Requirements', key: 'Conflict Policy' },
  'evidence.tier_preference': { section: 'Evidence Requirements', key: 'Tier Preference' },
  constraints: { section: 'Cross-Field Constraints', key: 'Constraints' },
  'component.type': { section: 'Components', key: 'Component Type' },
  aliases: { section: 'Extraction Hints & Aliases', key: 'Aliases' },
  'ui.tooltip_md': { section: 'Extraction Hints & Aliases', key: 'Tooltip Markdown' },
  'search_hints.domain_hints': { section: 'Search Hints', key: 'Domain Hints' },
  'search_hints.preferred_content_types': { section: 'Search Hints', key: 'Preferred Content Types' },
  'search_hints.query_terms': { section: 'Search Hints', key: 'Query Terms' },
};
