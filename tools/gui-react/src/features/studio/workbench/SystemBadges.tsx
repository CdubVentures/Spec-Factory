...
// WHY: bg/fg/border come from `cfg.cls` (semantic class backed by tokens).
// Layout-only inline styles stay here; color comes from the className.
        ...
        return (
          <Tooltip.Root key={consumerKey} delayDuration={200}>
            <Tooltip.Trigger asChild>
              <span style={badgeStyle} className={cfg.cls}>
                {label}
              </span>
            </Tooltip.Trigger>
            <Tooltip.Portal>
