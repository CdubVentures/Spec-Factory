...
// WHY: Old saved configs may omit the `priority` field — default to true so
// they keep working. Missing canonical views are added back with priority:false.
...
export function PifSettingsForm({ settings, category, isSaving, onSave }: ModuleSettingsFormProps) {
