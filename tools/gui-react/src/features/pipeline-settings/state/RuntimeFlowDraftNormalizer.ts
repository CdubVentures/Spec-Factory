...
export function normalizeRuntimeDraft(
  ...
  return {
    ...
    llmTriageUseReasoning: parseBoolean(raw.llmTriageUseReasoning, fallback.llmTriageUseReasoning),
    ...
    llmExtractBaseUrl: parseString(raw.llmExtractBaseUrl, fallback.llmExtractBaseUrl, true),
    llmExtractApiKey: parseString(raw.llmExtractApiKey, fallback.llmExtractApiKey, true),
    llmValidateProvider: parseString(raw.llmValidateProvider, fallback.llmValidateProvider, true),
    llmValidateBaseUrl: parseString(raw.llmValidateBaseUrl, fallback.llmValidateBaseUrl, true),
    llmValidateApiKey: parseString(raw.llmValidateApiKey, fallback.llmValidateApiKey, true),
    llmWriteProvider: parseString(raw.llmWriteProvider, fallback.llmWriteProvider, true),
    llmWriteBaseUrl: parseString(raw.llmWriteBaseUrl, fallback.llmWriteBaseUrl, true),
    llmWriteApiKey: parseString(raw.llmWriteApiKey, fallback.llmWriteApiKey, true),
