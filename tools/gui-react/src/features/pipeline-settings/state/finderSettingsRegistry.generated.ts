...
export const FINDER_SETTINGS_REGISTRY: Record<FinderIdWithSettings, readonly FinderSettingsEntry[]> = {
  ...
  'keyFinder': [
    ...
    { key: 'bundlingPassengerVariantCostPerExtra', type: 'float', default: 0.25, min: 0, max: 10, uiLabel: 'Passenger variant cost per extra', uiTip: 'Additional passenger-cost points added for each family variant beyond the first. Example: easy base cost 1 plus 0.25 means family size 2 costs 1.25, size 3 costs 1.5, size 4 costs 1.75.', uiGroup: 'Bundling' },
