...
export const FINDER_SETTINGS_REGISTRY: Record<FinderIdWithSettings, readonly FinderSettingsEntry[]> = {
  ...
  'productImageFinder': [
    ...
    { key: 'viewAttemptBudget', type: 'int', default: 5, min: 1, max: 50, uiLabel: 'Default View Attempt Budget', uiGroup: 'Carousel Strategy (Loop Run)' },
    { key: 'viewAttemptBudgets', type: 'string', default: "", uiLabel: 'Per-View Attempt Budgets (JSON)', uiGroup: 'Carousel Strategy (Loop Run)', allowEmpty: true },
    { key: 'reRunBudget', type: 'int', default: 1, min: 0, max: 5, uiLabel: 'Re-run Budget', uiTip: 'Extra LLM calls per view when re-looping an already-satisfied variant. 0 = skip.', uiGroup: 'Carousel Strategy (Loop Run)' },
