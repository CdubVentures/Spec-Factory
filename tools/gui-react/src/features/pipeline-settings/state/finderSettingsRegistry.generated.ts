...
export const FINDER_SETTINGS_REGISTRY: Record<FinderIdWithSettings, readonly FinderSettingsEntry[]> = {
  ...
  'productImageFinder': [
    ...
    { key: 'individualViewRunImageHistoryEnabled', type: 'bool', default: false, uiLabel: 'Individual View Run Image History', uiTip: 'Inject accepted image history for the variant into per-view button prompts. Exact duplicates are discouraged without blocking better versions or alternate angles.', uiGroup: 'Image History' },
    { key: 'loopRunImageHistoryEnabled', type: 'bool', default: false, uiLabel: 'Loop Run Image History', uiTip: 'Inject accepted image history for the variant into Loop prompts across view and hero iterations.', uiGroup: 'Image History' },
    { key: 'priorityViewRunLinkValidationEnabled', type: 'bool', default: false, uiLabel: 'Priority View Run Link Validation', uiTip: 'Inject the link-validation checklist and known candidate outcomes into Priority View Run prompts.', uiGroup: 'Link Validation' },
    { key: 'individualViewRunLinkValidationEnabled', type: 'bool', default: false, uiLabel: 'Individual View Run Link Validation', uiTip: 'Inject the link-validation checklist and known candidate outcomes into per-view button prompts.', uiGroup: 'Link Validation' },
    { key: 'loopRunLinkValidationEnabled', type: 'bool', default: false, uiLabel: 'Loop Run Link Validation', uiTip: 'Inject the link-validation checklist and known candidate outcomes into Loop prompts across view and hero iterations.', uiGroup: 'Link Validation' },
