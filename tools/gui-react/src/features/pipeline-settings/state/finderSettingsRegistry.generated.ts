...
export const FINDER_SETTINGS_REGISTRY: Record<FinderIdWithSettings, readonly FinderSettingsEntry[]> = {
  ...
  'keyFinder': [
    ...
    { key: 'budgetVariantPointsPerExtra', type: 'int', default: 1, min: 0, max: 10, uiLabel: 'Variant points per extra', uiTip: 'Points added to the per-key attempt budget for each variant beyond the first. Does NOT scale bundling passenger cost — passenger cost is always the raw bundlingPassengerCost value.', uiGroup: 'Budget Scoring' },
