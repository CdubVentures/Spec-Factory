...
export function collectRuntimeFlowDraftPayload({
  ...
  return collectRuntimeSettingsPayload({
    ...
    enableSourceRegistry: nextRuntimeDraft.enableSourceRegistry,
    enableDomainHintResolverV2: nextRuntimeDraft.enableDomainHintResolverV2,
    enableQueryCompiler: nextRuntimeDraft.enableQueryCompiler,
    enableCoreDeepGates: nextRuntimeDraft.enableCoreDeepGates,
