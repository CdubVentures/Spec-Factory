...
export function collectRuntimeSettingsPayload(
  ...
  return {
    ...
    googleSearchProxyUrlsJson: String(input.googleSearchProxyUrlsJson || '[]').trim(),
    googleSearchTimeoutMs: parseRuntimeInt(
      input.googleSearchTimeoutMs,
      runtimeSettingsFallbackBaseline.googleSearchTimeoutMs,
    ),
    googleSearchMinQueryIntervalMs: parseRuntimeInt(
      input.googleSearchMinQueryIntervalMs,
      runtimeSettingsFallbackBaseline.googleSearchMinQueryIntervalMs,
    ),
    googleSearchMaxRetries: parseRuntimeInt(
      input.googleSearchMaxRetries,
    ...
    llmMaxOutputTokensPlanFallback: clampTokenForModel(
      input.llmPlanFallbackModel || input.llmModelPlan,
      input.llmMaxOutputTokensPlanFallback,
      resolveModelTokenDefaults,
    ),
    llmMaxOutputTokensReasoningFallback: clampTokenForModel(
      input.llmReasoningFallbackModel || input.llmModelReasoning,
