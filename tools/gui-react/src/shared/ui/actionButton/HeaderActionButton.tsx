// WHY: Header-scope action button. Fixed h-8 / text-[11px] / px-3 so every
// indexing-lab panel header renders pixel-identical buttons regardless of
...
export interface HeaderActionButtonProps {
  ...
  /** Visible label. ReactNode so callers can embed inline suffixes (e.g. count badges). */
  ...
  /** Optional width class (e.g. 'w-28', 'w-36'). Siblings in the same section
