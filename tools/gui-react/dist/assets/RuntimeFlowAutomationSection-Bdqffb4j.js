import{r as b,j as e}from"./vendor-ui-ComJg1Ad.js";import{an as x,ar as y,ap as h,ao as t,aq as r,as as p}from"./index-BHo3WI1y.js";import"./vendor-react-yyJz49DP.js";import"./vendor-query-B32LnyU-.js";const o="Phase coverage: background control plane around the main 01-13 run lifecycle, not a single in-run stage.",j=b.memo(function({runtimeDraft:i,runtimeSettingsReady:s,inputCls:a,runtimeSubStepDomId:m,updateDraft:c,onNumberChange:n,getNumberBounds:d}){return e.jsxs(e.Fragment,{children:[e.jsx("div",{id:m("automation-drift"),className:"scroll-mt-24"}),e.jsxs(x,{title:"Drift Detection",children:[e.jsx(y,{label:"Drift Detection Enabled",tip:`${o}
...
What this controls: how many days a source may age before automation treats it as stale and eligible for recrawl.`,children:e.jsx(r,{draftKey:"reCrawlStaleAfterDays",value:i.reCrawlStaleAfterDays,bounds:d("reCrawlStaleAfterDays"),step:1,disabled:!s,className:a,onNumberChange:n})})]})]}),e.jsx("div",{id:m("automation-learning"),className:"scroll-mt-24"}),e.jsxs(x,{title:"Self-Improvement",children:[e.jsx(y,{label:"Self Improve Enabled",tip:`${o}
