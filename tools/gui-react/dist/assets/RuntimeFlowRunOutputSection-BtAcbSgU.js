import{r as d,j as e}from"./vendor-ui-ComJg1Ad.js";import{an as p,ao as i,ap as r,as as x}from"./index-BSdPNdYC.js";import"./vendor-react-yyJz49DP.js";import"./vendor-query-B32LnyU-.js";const s="Phase coverage: Stage 13 Validation To Output plus durable artifact persistence across the full run.",S=d.memo(function({runtimeDraft:o,runtimeSettingsReady:n,inputCls:l,runtimeSubStepDomId:u,updateDraft:a,storageAwsRegion:h,storageS3Bucket:c}){return e.jsxs(e.Fragment,{children:[e.jsx("div",{id:u("run-output-destinations"),className:"scroll-mt-24"}),e.jsxs(p,{title:"Output Destinations",children:[e.jsx(i,{label:"Output Mode",tip:`${s}
...
Lives in: shared storage configuration.
What this controls: the bucket name used for input and output mirroring.`,description:"Configured on Storage tab.",children:e.jsx("span",{className:"sf-text-label",children:c||o.s3Bucket||"(not set)"})})]})]})]})});export{S as RuntimeFlowRunOutputSection};
