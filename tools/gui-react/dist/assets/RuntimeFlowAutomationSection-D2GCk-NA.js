import{r as y,j as e}from"./vendor-ui-ComJg1Ad.js";import{ap as x,at as u,ar as h,aq as t,as as r,au as p}from"./index-BTB-I1KN.js";import"./vendor-react-yyJz49DP.js";import"./vendor-query-B32LnyU-.js";const o="Phase coverage: background control plane around the main 01-13 run lifecycle, not a single in-run stage.",j=y.memo(function({runtimeDraft:i,runtimeSettingsReady:s,inputCls:a,runtimeSubStepDomId:m,updateDraft:c,onNumberChange:n,getNumberBounds:d}){return e.jsxs(e.Fragment,{children:[e.jsx("div",{id:m("automation-drift"),className:"scroll-mt-24"}),e.jsxs(x,{title:"Drift Detection",children:[e.jsx(u,{label:"Drift Detection Enabled",tip:`${o}
...
What this controls: how many days a source may age before automation treats it as stale and eligible for recrawl.`,children:e.jsx(r,{draftKey:"reCrawlStaleAfterDays",value:i.reCrawlStaleAfterDays,bounds:d("reCrawlStaleAfterDays"),step:1,disabled:!s,className:a,onNumberChange:n})})]})]}),e.jsx("div",{id:m("automation-learning"),className:"scroll-mt-24"}),e.jsxs(x,{title:"Self-Improvement",children:[e.jsx(u,{label:"Self Improve Enabled",tip:`${o}
...
What this controls: the cap on network responses inspected while mining endpoint signals.`,children:e.jsx(r,{draftKey:"endpointNetworkScanLimit",value:i.endpointNetworkScanLimit,bounds:d("endpointNetworkScanLimit"),step:1,disabled:!s,className:a,onNumberChange:n})})]})]}),e.jsx("div",{id:m("automation-helper"),className:"scroll-mt-24"}),e.jsxs(x,{title:"Helper Runtime",children:[e.jsx(u,{label:"Category Authority Enabled",tip:`${o}
