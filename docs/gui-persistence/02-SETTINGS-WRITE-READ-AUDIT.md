...
Latest full-knob audit artifacts:

- `implementation/gui-persistence/04-LLM-ROUTE-FIELD-USAGE-AUDIT.json`
- historical frontend snapshots: `implementation/gui-persistence/archive/03-FRONTEND-KNOB-AUDIT-2026-02-26.md`, `implementation/gui-persistence/archive/02-FRONTEND-KNOB-AUDIT-2026-02-25.md`, `implementation/gui-persistence/archive/01-FRONTEND-KNOB-AUDIT-2026-02-24.md`
- historical settings-knob usage snapshot: `implementation/gui-persistence/archive/04-SETTINGS-KNOB-USAGE-AUDIT-2026-02-24.json`
...
Canonical registry file: `implementation/gui-persistence/03-UI-STATE-STORES.md`
...
- `implementation/gui-persistence/04-LLM-ROUTE-FIELD-USAGE-AUDIT.json` is generated from source by `scripts/generate-llm-route-field-usage-audit.js`.
