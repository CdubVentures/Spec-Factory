...
| Pipeline and Runtime Settings | Persists runtime, UI, storage, source-strategy, and category LLM route-matrix settings through the settings-authority and source-strategy APIs. | [pipeline-and-runtime-settings.md](./pipeline-and-runtime-settings.md) | `src/features/settings/api/configRoutes.js`, `src/features/indexing/api/sourceStrategyRoutes.js`, `tools/gui-react/src/features/pipeline-settings/components/PipelineSettingsPage.tsx` |
