...
| Dependency | Version | Purpose | Category |
|-----------|---------|---------|----------|
| `@aws-sdk/client-s3` | `3.985.0` | optional S3 storage backend | production |
...
| `playwright` | `1.58.2` | browser automation and GUI contract coverage | production |
...
| `@tanstack/react-table` | `8.21.3` | table rendering | production |
...
- [Setup and Installation](./setup-and-installation.md) - Uses this stack inventory to define local setup.
