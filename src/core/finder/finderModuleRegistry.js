  ...
  },
  {
    ...
    settingsSchema: [
      ...
      { key: 'budgetVariantPointsPerExtra', type: 'float', default: 0.25, min: 0, max: 10,
        ...
        uiTip: 'Points added to the per-key attempt budget for each variant beyond the first. Fractional so variant count is a gentle accrual, not a whole-point punch per variant. Raw budget accrues the fractional value; final attempts = ceil(raw). Does NOT scale bundling passenger cost — passenger cost is always the raw bundlingPassengerCost value.' },
      ...
      { key: 'passengerExcludeAtConfidence', type: 'int', default: 0, min: 0, max: 100,
      ...
      { key: 'passengerExcludeMinEvidence', type: 'int', default: 0, min: 0, max: 50,
