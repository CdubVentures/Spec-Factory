...
export function buildLlmCallDeps({ config, logger, onPhaseChange, onModelResolved, onStreamChunk }) {
  return { callRoutedLlmFn: callLlmWithRouting, config, logger, onPhaseChange, onModelResolved, onStreamChunk };
}
