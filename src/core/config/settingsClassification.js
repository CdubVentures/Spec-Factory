...
export const EXPLICIT_ENV_KEY_OVERRIDES = new Map([
  ...
  ['llmProvider', ['LLM_PROVIDER', 'LLM_BASE_URL', 'OPENAI_BASE_URL', 'LLM_MODEL_EXTRACT', 'OPENAI_MODEL_EXTRACT']],
  ['llmBaseUrl', ['LLM_BASE_URL', 'OPENAI_BASE_URL']],
  ['llmModelPlan', ['LLM_MODEL_PLAN', 'LLM_MODEL_EXTRACT', 'OPENAI_MODEL_PLAN', 'OPENAI_MODEL_EXTRACT']],
  ['llmModelReasoning', ['LLM_MODEL_REASONING', 'LLM_MODEL_EXTRACT', 'OPENAI_MODEL_EXTRACT']],
