    ...
    [
      {
        ...
        description: 'Per-primary-field instructions for how to use {{VARIANT_INVENTORY}} as an evidence filter. Generated deterministically when ai_assist.variant_inventory_usage.enabled is not false. Enable only when variant identity adds value without ambiguity; field-specific union/exact/base/default interpretation belongs in ai_assist.reasoning_note.',
      },
      {
