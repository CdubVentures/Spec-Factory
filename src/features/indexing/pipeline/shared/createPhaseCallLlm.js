...
export function createPhaseCallLlm({ callRoutedLlmFn, config, logger, onPhaseChange, onModelResolved, onStreamChunk }, { phase, reason, role, system, jsonSchema }, mapArgs) {
