...
// ---------------------------------------------------------------------------
// Sub-schemas: NeedSet (Stage 01) output shapes
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Sub-schemas: Search Profile (Stage 03) output shapes
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Sub-schemas: typed elements for Stage 06 array outputs
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Checkpoint: AfterBootstrap — Stage 01+02 parallel + orchestrator computations
// ---------------------------------------------------------------------------

export const pipelineContextAfterBootstrap = pipelineContextSeed.extend({
  // Stage 01 (NeedSet) output
  ...
  // Stage 02 (Brand Resolver) output
  ...
  // Computed by orchestrator after Stage 01+02
  variables: z.object({
...
// ---------------------------------------------------------------------------
// Checkpoint: AfterProfile — Stage 03 (Search Profile)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Checkpoint: AfterPlanner — Stage 04 (Search Planner)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Checkpoint: AfterJourney — Stage 05 (Query Journey)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Checkpoint: AfterExecution — Stage 06 (Search Execution)
// ---------------------------------------------------------------------------

export const pipelineContextAfterExecution = pipelineContextAfterJourney.extend({
  // Computed by orchestrator before Stage 06
...
// ---------------------------------------------------------------------------
// Sub-schemas: Stage 07 (Result Processor) output shapes
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Checkpoint: AfterResults — Stage 07 (Result Processor)
// WHY: discoveryResult stays nested because it IS the final pipeline output.
// Stage 08 attaches enqueue_summary directly onto it.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Checkpoint: Final — Stage 08 (Domain Classifier)
// WHY: No new top-level fields. Stage 08 attaches enqueue_summary to
