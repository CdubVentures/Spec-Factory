...
export const CATALOG_ROW_SHAPE = Object.freeze([
  ...
  { key: 'pifDependencyReady', coerce: 'bool', optional: true },
  { key: 'pifDependencyRequiredKeys', coerce: 'array', optional: true, itemType: 'string' },
  { key: 'pifDependencyResolvedKeys', coerce: 'array', optional: true, itemType: 'string' },
  { key: 'pifDependencyMissingKeys', coerce: 'array', optional: true, itemType: 'string' },
