...
export const PRODUCT_SUMMARY_SHAPE = Object.freeze([
  ...
  { key: 'fields_below_pass_target', coerce: 'array', itemType: 'string' },
  { key: 'critical_fields_below_pass_target', coerce: 'array', itemType: 'string' },
  { key: 'missing_required_fields', coerce: 'array', itemType: 'string' },
