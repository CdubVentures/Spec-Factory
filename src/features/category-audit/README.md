...
- `generateCategoryAuditReportPack({ category, consumer, config, outputRoot, templateOverride }) -> Promise<{ categoryReport, perKeyDocs, promptAudit, keysOrderAudit }>` - regenerates the full category audit pack after imported settings change.
