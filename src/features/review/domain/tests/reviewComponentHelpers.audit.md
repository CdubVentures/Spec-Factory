...
| `enforceNonDiscoveredRows normalizes and preserves discovery flags` | KEEP | Protects discovery-flag normalization and passthrough. | `reviewComponentHelpers.discoveryContracts.test.js` | Preserved |
