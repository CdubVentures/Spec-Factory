...
- The assembled return shape (8 groups, 48 keys total) is the contract with guiServer.js. Never add/remove keys without updating guiServer.js and BOOTSTRAP_RETURN_GROUPS.
