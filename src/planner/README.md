...
- `sourcePlanner.js`: `.updateBrandHints(brandResolution)` — called after the Brand Resolver phase to wire LLM-resolved brand aliases into manufacturer host filtering.
