...
export function createPurgeStore({ db, category: defaultCategory }) {
  ...
  function purgeCategoryState(category) {
    ...
    if (!cat) {
      return { clearedSources: 0, clearedCandidates: 0, clearedFieldState: 0, clearedComponentData: 0, clearedEnumData: 0, clearedCatalogState: 0, clearedArtifacts: 0 };
    }

    let clearedSources = 0, clearedFieldState = 0;
    ...
    return { clearedSources, clearedCandidates: 0, clearedFieldState, clearedComponentData, clearedEnumData, clearedCatalogState, clearedArtifacts };
  }
  ...
  function purgeProductReviewState(category, productId) {
    ...
    if (!cat || !pid) {
      return { clearedCandidates: 0, clearedFieldState: 0, clearedLinks: 0, clearedSources: 0 };
    }
    ...
    return { clearedCandidates: 0, clearedFieldState: deletedFieldState, clearedLinks: deletedLinks, clearedSources: deletedSources };
  }
