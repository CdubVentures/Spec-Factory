    ...
    if (existing) {
      db.prepare(`
        UPDATE key_review_state SET
          ...
          ai_confirm_primary_status = COALESCE(ai_confirm_primary_status, @ai_confirm_primary_status),
          ai_confirm_primary_confidence = COALESCE(ai_confirm_primary_confidence, @ai_confirm_primary_confidence),
          ai_confirm_primary_at = COALESCE(ai_confirm_primary_at, @ai_confirm_primary_at),
          ai_confirm_primary_interrupted = @ai_confirm_primary_interrupted,
          ai_confirm_primary_error = COALESCE(ai_confirm_primary_error, @ai_confirm_primary_error),
          ai_confirm_shared_status = COALESCE(ai_confirm_shared_status, @ai_confirm_shared_status),
          ai_confirm_shared_confidence = COALESCE(ai_confirm_shared_confidence, @ai_confirm_shared_confidence),
          ai_confirm_shared_at = COALESCE(ai_confirm_shared_at, @ai_confirm_shared_at),
          ai_confirm_shared_interrupted = @ai_confirm_shared_interrupted,
          ai_confirm_shared_error = COALESCE(ai_confirm_shared_error, @ai_confirm_shared_error),
          user_accept_primary_status = COALESCE(user_accept_primary_status, @user_accept_primary_status),
          user_accept_primary_at = COALESCE(user_accept_primary_at, @user_accept_primary_at),
          user_accept_primary_by = COALESCE(user_accept_primary_by, @user_accept_primary_by),
          user_accept_shared_status = COALESCE(user_accept_shared_status, @user_accept_shared_status),
          user_accept_shared_at = COALESCE(user_accept_shared_at, @user_accept_shared_at),
          user_accept_shared_by = COALESCE(user_accept_shared_by, @user_accept_shared_by),
          user_override_ai_primary = @user_override_ai_primary,
          user_override_ai_primary_at = COALESCE(user_override_ai_primary_at, @user_override_ai_primary_at),
          user_override_ai_primary_reason = COALESCE(user_override_ai_primary_reason, @user_override_ai_primary_reason),
          user_override_ai_shared = @user_override_ai_shared,
          user_override_ai_shared_at = COALESCE(user_override_ai_shared_at, @user_override_ai_shared_at),
          user_override_ai_shared_reason = COALESCE(user_override_ai_shared_reason, @user_override_ai_shared_reason),
          updated_at = datetime('now')
        WHERE id = @id
