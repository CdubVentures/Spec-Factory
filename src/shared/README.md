...
- `src/shared/contentHash.js`: `computePageContentHash(html)`, `computeFileContentHash(buffer)`, `sha256Hex(value)` — SHA-256 content hashing for artifact dedup, content-addressed file naming, and hash-gated seed reconciliation.
