...
export const RUNTIME_SETTINGS_REGISTRY = Object.freeze([
  ...
  { key: "llmMaxCallsPerProductTotal", type: "int", default: 14, min: 1, max: 100, configKey: "llmMaxCallsPerProductTotal", envKey: "LLM_MAX_CALLS_PER_PRODUCT_TOTAL", group: "llm", uiCategory: "extraction", uiSection: "limits", uiGroup: "Call Limits", uiTip: "Maximum total LLM calls allowed per product" },
  { key: "llmMaxCallsPerRound", type: "int", default: 5, min: 1, max: 200, configKey: "llmMaxCallsPerRound", envKey: "LLM_MAX_CALLS_PER_ROUND", group: "llm", uiCategory: "extraction", uiSection: "limits", uiGroup: "Call Limits", uiTip: "Maximum LLM calls per extraction round" },
  ...
  // NeedSet
  { key: "needsetMaxFocusFields", type: "int", default: 10, min: 1, max: 50, configKey: "needsetMaxFocusFields", envKey: "NEEDSET_MAX_FOCUS_FIELDS", group: "misc", uiCategory: "planner", uiSection: "needset", uiTip: "Maximum number of focus fields the NeedSet can select per product" },
  { key: "needsetConfidenceThresholdMatched", type: "float", default: 0.95, min: 0, max: 1, configKey: "needsetConfidenceThresholdMatched", envKey: "NEEDSET_CONFIDENCE_THRESHOLD_MATCHED", group: "misc", uiCategory: "planner", uiSection: "needset", uiTip: "Confidence score above which a field is considered matched" },
  { key: "needsetConfidenceThresholdPossible", type: "float", default: 0.70, min: 0, max: 1, configKey: "needsetConfidenceThresholdPossible", envKey: "NEEDSET_CONFIDENCE_THRESHOLD_POSSIBLE", group: "misc", uiCategory: "planner", uiSection: "needset", uiTip: "Confidence score above which a field is considered possible" },
  { key: "needsetGroupQueryTermsCap", type: "int", default: 5, min: 1, max: 20, configKey: "needsetGroupQueryTermsCap", envKey: "NEEDSET_GROUP_QUERY_TERMS_CAP", group: "misc", uiCategory: "planner", uiSection: "needset", uiTip: "Maximum query terms generated per field group" },
  ...
  // Fetcher — Network (bypass detection)
  { key: "crawlBypassMinBodyLength", type: "int", default: 200, min: 0, max: 10000, configKey: "crawlBypassMinBodyLength", envKey: "CRAWL_BYPASS_MIN_BODY_LENGTH", group: "runtime", uiCategory: "fetcher", uiSection: "network", uiGroup: "Bypass Detection", uiTip: "Minimum response body length to consider a page valid (bypass detection)" },
  { key: "crawlBypassHtmlSnippetCap", type: "int", default: 5000, min: 500, max: 50000, configKey: "crawlBypassHtmlSnippetCap", envKey: "CRAWL_BYPASS_HTML_SNIPPET_CAP", group: "runtime", uiCategory: "fetcher", uiSection: "network", uiGroup: "Bypass Detection", uiTip: "Max HTML snippet length stored for bypass analysis" },
