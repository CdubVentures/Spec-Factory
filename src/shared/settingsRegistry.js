...
export const RUNTIME_SETTINGS_REGISTRY = Object.freeze([
  { key: "anthropicApiKey", type: "string", default: "", secret: true, allowEmpty: true, policyGroup: "apiKeys", policyField: "anthropic", configKey: "anthropicApiKey", envKey: "ANTHROPIC_API_KEY", group: "llm", uiCategory: "extraction", uiSection: "api-keys" },
  ...
  { key: "awsRegion", type: "string", default: "us-east-2", readOnly: true, configKey: "awsRegion", envKey: "AWS_REGION", group: "storage", uiCategory: "flow", uiSection: "cloud" },
  ...
  { key: "categoryAuthorityEnabled", type: "bool", default: true, aliases: ["helperFilesEnabled"], configKey: "categoryAuthorityEnabled", envKey: "HELPER_FILES_ENABLED", group: "misc", uiCategory: "flow", uiSection: "automation" },
  { key: "categoryAuthorityRoot", type: "string", default: "category_authority", allowEmpty: true, aliases: ["helperFilesRoot"], configKey: "categoryAuthorityRoot", envKey: "CATEGORY_AUTHORITY_ROOT", group: "paths", uiCategory: "flow", uiSection: "automation" },
  ...
  { key: "crawlSessionCount", type: "int", default: 4, min: 1, max: 20, configKey: "crawlSessionCount", envKey: "CRAWL_SESSION_COUNT", group: "misc", uiCategory: "fetcher", uiSection: "throughput", uiHero: true },
  { key: "deepseekApiKey", type: "string", default: "", secret: true, allowEmpty: true, policyGroup: "apiKeys", policyField: "deepseek", configKey: "deepseekApiKey", envKey: "DEEPSEEK_API_KEY", group: "llm", uiCategory: "extraction", uiSection: "api-keys" },
  ...
  { key: "frontierBackoffMaxExponent", type: "int", default: 4, min: 1, max: 12, configKey: "frontierBackoffMaxExponent", envKey: "FRONTIER_BACKOFF_MAX_EXPONENT", group: "paths", uiCategory: "fetcher", uiSection: "cooldowns" },
  { key: "frontierBlockedDomainThreshold", type: "int", default: 1, min: 1, max: 50, configKey: "frontierBlockedDomainThreshold", envKey: "FRONTIER_BLOCKED_DOMAIN_THRESHOLD", group: "paths", uiCategory: "fetcher", uiSection: "cooldowns" },
  { key: "frontierCooldown403BaseSeconds", type: "int", default: 1800, min: 0, max: 86400, configKey: "frontierCooldown403BaseSeconds", envKey: "FRONTIER_COOLDOWN_403_BASE", group: "paths", uiCategory: "fetcher", uiSection: "cooldowns" },
  { key: "frontierCooldown404RepeatSeconds", type: "int", default: 1209600, min: 0, max: 31536000, configKey: "frontierCooldown404RepeatSeconds", envKey: "FRONTIER_COOLDOWN_404_REPEAT", group: "paths", uiCategory: "fetcher", uiSection: "cooldowns" },
  { key: "frontierCooldown404Seconds", type: "int", default: 259200, min: 0, max: 31536000, configKey: "frontierCooldown404Seconds", envKey: "FRONTIER_COOLDOWN_404", group: "paths", uiCategory: "fetcher", uiSection: "cooldowns" },
  { key: "frontierCooldown410Seconds", type: "int", default: 7776000, min: 0, max: 31536000, configKey: "frontierCooldown410Seconds", envKey: "FRONTIER_COOLDOWN_410", group: "paths", uiCategory: "fetcher", uiSection: "cooldowns" },
  { key: "frontierCooldown429BaseSeconds", type: "int", default: 600, min: 0, max: 86400, configKey: "frontierCooldown429BaseSeconds", envKey: "FRONTIER_COOLDOWN_429_BASE", group: "paths", uiCategory: "fetcher", uiSection: "cooldowns" },
  { key: "frontierCooldownTimeoutSeconds", type: "int", default: 21600, min: 0, max: 31536000, configKey: "frontierCooldownTimeoutSeconds", envKey: "FRONTIER_COOLDOWN_TIMEOUT", group: "paths", uiCategory: "fetcher", uiSection: "cooldowns" },
  { key: "frontierDbPath", type: "string", default: "_intel/frontier/frontier.json", allowEmpty: true, configKey: "frontierDbPath", envKey: "FRONTIER_DB_PATH", group: "paths", uiCategory: "fetcher", uiSection: "frontier" },
  { key: "frontierPathPenaltyNotfoundThreshold", type: "int", default: 3, min: 1, max: 50, configKey: "frontierPathPenaltyNotfoundThreshold", envKey: "FRONTIER_PATH_PENALTY_NOTFOUND_THRESHOLD", group: "paths", uiCategory: "fetcher", uiSection: "cooldowns" },
  { key: "frontierQueryCooldownSeconds", type: "int", default: 21600, min: 0, max: 31536000, configKey: "frontierQueryCooldownSeconds", envKey: "FRONTIER_QUERY_COOLDOWN_SECONDS", group: "paths", uiCategory: "fetcher", uiSection: "frontier" },
  { key: "frontierStripTrackingParams", type: "bool", default: true, configKey: "frontierStripTrackingParams", envKey: "FRONTIER_STRIP_TRACKING_PARAMS", group: "paths", uiCategory: "fetcher", uiSection: "frontier" },
  { key: "geminiApiKey", type: "string", default: "", secret: true, allowEmpty: true, policyGroup: "apiKeys", policyField: "gemini", configKey: "geminiApiKey", envKey: "GEMINI_API_KEY", group: "misc", uiCategory: "extraction", uiSection: "api-keys" },
  { key: "googleSearchMaxRetries", type: "int", default: 1, min: 0, max: 3, configKey: "googleSearchMaxRetries", envKey: "GOOGLE_SEARCH_MAX_RETRIES", group: "misc", uiCategory: "planner", uiSection: "engines" },
  { key: "googleSearchMinQueryIntervalMs", type: "int", default: 1000, min: 0, max: 60000, configKey: "googleSearchMinQueryIntervalMs", envKey: "GOOGLE_SEARCH_MIN_QUERY_INTERVAL_MS", group: "misc", uiCategory: "planner", uiSection: "engines" },
  { key: "googleSearchProxyUrlsJson", type: "string", default: "[\"http://zruyrjpq-rotate:dfm4udpzx5p0@p.webshare.io:80\"]", allowEmpty: true, configKey: "googleSearchProxyUrlsJson", envKey: "", uiCategory: "planner", uiSection: "engines" },
  { key: "googleSearchScreenshotsEnabled", type: "bool", default: true, configKey: "googleSearchScreenshotsEnabled", envKey: "GOOGLE_SEARCH_SCREENSHOTS_ENABLED", group: "misc", uiCategory: "planner", uiSection: "engines" },
  { key: "googleSearchTimeoutMs", type: "int", default: 30000, min: 30000, max: 120000, configKey: "googleSearchTimeoutMs", envKey: "GOOGLE_SEARCH_TIMEOUT_MS", group: "misc", uiCategory: "planner", uiSection: "engines" },
  ...
  { key: "indexingResumePersistLimit", type: "int", default: 160, min: 1, max: 100000, configKey: "indexingResumePersistLimit", envKey: "INDEXING_RESUME_PERSIST_LIMIT", group: "runtime", uiCategory: "flow", uiSection: "resume" },
  { key: "indexingResumeSeedLimit", type: "int", default: 24, min: 1, max: 10000, configKey: "indexingResumeSeedLimit", envKey: "INDEXING_RESUME_SEED_LIMIT", group: "runtime", uiCategory: "flow", uiSection: "resume" },
  { key: "llmEnhancerMaxRetries", type: "int", default: 2, min: 1, max: 5, configKey: "llmEnhancerMaxRetries", envKey: "LLM_ENHANCER_MAX_RETRIES", group: "misc", uiCategory: "planner", uiSection: "planner-llm" },
  ...
  { key: "llmCostCachedInputPer1M", type: "float", default: 0.125, min: 0, max: 1000, policyGroup: "budget", policyField: "costCachedInputPer1M", configKey: "llmCostCachedInputPer1M", envKey: "LLM_COST_CACHED_INPUT_PER_1M", group: "llm", uiCategory: "extraction", uiSection: "budget" },
  { key: "llmCostInputPer1M", type: "float", default: 1.25, min: 0, max: 1000, policyGroup: "budget", policyField: "costInputPer1M", configKey: "llmCostInputPer1M", envKey: "LLM_COST_INPUT_PER_1M", group: "llm", uiCategory: "extraction", uiSection: "budget" },
  { key: "llmCostOutputPer1M", type: "float", default: 10, min: 0, max: 1000, policyGroup: "budget", policyField: "costOutputPer1M", configKey: "llmCostOutputPer1M", envKey: "LLM_COST_OUTPUT_PER_1M", group: "llm", uiCategory: "extraction", uiSection: "budget" },
  ...
  { key: "llmMaxOutputTokens", type: "int", default: 1400, min: 128, max: 262144, policyGroup: "tokens", policyField: "maxOutput", configKey: "llmMaxOutputTokens", envKey: "LLM_MAX_OUTPUT_TOKENS", group: "llm", uiCategory: "extraction", uiSection: "tokens" },
  { key: "llmMaxOutputTokensPlan", type: "int", default: 4096, min: 128, max: 262144, tokenClamped: true, clampModelKey: "llmModelPlan", aliases: ["llmTokensPlan"], policyGroup: "tokens", policyField: "plan", configKey: "llmMaxOutputTokensPlan", envKey: "LLM_MAX_OUTPUT_TOKENS_PLAN", group: "llm", uiCategory: "extraction", uiSection: "tokens" },
  { key: "llmMaxOutputTokensPlanFallback", type: "int", default: 2048, min: 128, max: 262144, tokenClamped: true, clampModelKey: "llmPlanFallbackModel", clampModelFallbackKey: "llmModelPlan", aliases: ["llmTokensPlanFallback"], policyGroup: "tokens", policyField: "planFallback", configKey: "llmMaxOutputTokensPlanFallback", envKey: "LLM_MAX_OUTPUT_TOKENS_PLAN_FALLBACK", group: "llm", uiCategory: "extraction", uiSection: "tokens" },
  { key: "llmMaxOutputTokensTriage", type: "int", default: 20000, min: 20000, max: 262144, tokenClamped: true, clampModelKey: "llmModelPlan", aliases: ["llmTokensTriage"], configKey: "llmMaxOutputTokensTriage", envKey: "LLM_MAX_OUTPUT_TOKENS_TRIAGE", group: "llm", uiCategory: "extraction", uiSection: "tokens" },
  { key: "llmMaxOutputTokensReasoning", type: "int", default: 4096, min: 128, max: 262144, tokenClamped: true, clampModelKey: "llmModelReasoning", aliases: ["llmTokensReasoning"], policyGroup: "tokens", policyField: "reasoning", configKey: "llmMaxOutputTokensReasoning", envKey: "LLM_MAX_OUTPUT_TOKENS_REASONING", group: "llm", uiCategory: "extraction", uiSection: "tokens" },
  { key: "llmMaxOutputTokensReasoningFallback", type: "int", default: 2048, min: 128, max: 262144, tokenClamped: true, clampModelKey: "llmReasoningFallbackModel", clampModelFallbackKey: "llmModelReasoning", aliases: ["llmTokensReasoningFallback"], policyGroup: "tokens", policyField: "reasoningFallback", configKey: "llmMaxOutputTokensReasoningFallback", envKey: "LLM_MAX_OUTPUT_TOKENS_REASONING_FALLBACK", group: "misc", uiCategory: "extraction", uiSection: "tokens" },
  { key: "llmMaxTokens", type: "int", default: 16384, min: 128, max: 262144, policyGroup: "tokens", policyField: "maxTokens", configKey: "llmMaxTokens", envKey: "LLM_MAX_TOKENS", group: "llm", uiCategory: "extraction", uiSection: "tokens" },
  ...
  { key: "llmMonthlyBudgetUsd", type: "float", default: 300, min: 0, max: 100000, policyGroup: "budget", policyField: "monthlyUsd", configKey: "llmMonthlyBudgetUsd", envKey: "LLM_MONTHLY_BUDGET_USD", group: "llm", uiCategory: "extraction", uiSection: "budget" },
  { key: "llmPerProductBudgetUsd", type: "float", default: 0.35, min: 0, max: 1000, policyGroup: "budget", policyField: "perProductUsd", configKey: "llmPerProductBudgetUsd", envKey: "LLM_PER_PRODUCT_BUDGET_USD", group: "llm", uiCategory: "extraction", uiSection: "budget" },
  { key: "llmPhaseOverridesJson", type: "string", default: "{}", allowEmpty: true, policyGroup: "_json", policyField: "phaseOverrides", configKey: "llmPhaseOverridesJson", envKey: "", uiCategory: "extraction", uiSection: "advanced" },
  { key: "llmPlanApiKey", type: "string", default: "", secret: true, allowEmpty: true, policyGroup: "apiKeys", policyField: "plan", configKey: "llmPlanApiKey", envKey: "LLM_PLAN_API_KEY", group: "llm", uiCategory: "extraction", uiSection: "api-keys" },
  ...
  { key: "llmPlanUseReasoning", type: "bool", default: false, policyGroup: "reasoning", policyField: "enabled", configKey: "llmPlanUseReasoning", envKey: "LLM_PLAN_USE_REASONING", group: "llm", uiCategory: "extraction", uiSection: "reasoning" },
  ...
  { key: "llmProviderRegistryJson", type: "string", default: DEFAULT_LLM_PROVIDER_REGISTRY_JSON, allowEmpty: true, policyGroup: "_json", policyField: "providerRegistry", configKey: "llmProviderRegistryJson", envKey: "", uiCategory: "extraction", uiSection: "advanced" },
  { key: "llmReasoningBudget", type: "int", default: 32768, min: 128, max: 262144, policyGroup: "reasoning", policyField: "budget", configKey: "llmReasoningBudget", envKey: "LLM_REASONING_BUDGET", group: "llm", uiCategory: "extraction", uiSection: "tokens" },
  ...
  { key: "llmReasoningMode", type: "bool", default: true, policyGroup: "reasoning", policyField: "mode", configKey: "llmReasoningMode", envKey: "LLM_REASONING_MODE", group: "llm", uiCategory: "extraction", uiSection: "reasoning" },
  ...
  { key: "maxRunSeconds", type: "int", default: 480, min: 30, max: 86400, configKey: "maxRunSeconds", envKey: "MAX_RUN_SECONDS", group: "misc", uiCategory: "flow", uiSection: "timeout", uiHero: true },
  { key: "mirrorToS3", type: "bool", default: false, configKey: "mirrorToS3", envKey: "MIRROR_TO_S3", group: "misc", uiCategory: "flow", uiSection: "cloud" },
  { key: "mirrorToS3Input", type: "bool", default: false, configKey: "mirrorToS3Input", envKey: "MIRROR_TO_S3_INPUT", group: "misc", uiCategory: "flow", uiSection: "cloud" },
  { key: "openaiApiKey", type: "string", default: "", secret: true, allowEmpty: true, policyGroup: "apiKeys", policyField: "openai", configKey: "openaiApiKey", envKey: "OPENAI_API_KEY", group: "llm", uiCategory: "extraction", uiSection: "api-keys" },
  ...
  { key: "pageGotoTimeoutMs", type: "int", default: 12000, min: 0, max: 120000, configKey: "pageGotoTimeoutMs", envKey: "PAGE_GOTO_TIMEOUT_MS", group: "misc", uiCategory: "fetcher", uiSection: "throughput" },
  { key: "pageNetworkIdleTimeoutMs", type: "int", default: 2000, min: 0, max: 60000, configKey: "pageNetworkIdleTimeoutMs", envKey: "PAGE_NETWORK_IDLE_TIMEOUT_MS", group: "misc", uiCategory: "fetcher", uiSection: "throughput" },
  { key: "perHostMinDelayMs", type: "int", default: 1500, min: 0, max: 120000, configKey: "perHostMinDelayMs", envKey: "PER_HOST_MIN_DELAY_MS", group: "misc", uiCategory: "fetcher", uiSection: "throughput" },
  ...
  { key: "postLoadWaitMs", type: "int", default: 200, min: 0, max: 60000, configKey: "postLoadWaitMs", envKey: "POST_LOAD_WAIT_MS", group: "misc", uiCategory: "fetcher", uiSection: "throughput" },
  { key: "repairDedupeRule", type: "enum", default: "domain_once", allowed: ["domain_once","domain_and_status","none"], configKey: "repairDedupeRule", envKey: "REPAIR_DEDUPE_RULE", group: "misc", uiCategory: "fetcher", uiSection: "frontier" },
  { key: "resumeMode", type: "enum", default: "auto", allowed: ["auto","force_resume","start_over"], configKey: "indexingResumeMode", envKey: "INDEXING_RESUME_MODE", group: "runtime", uiCategory: "flow", uiSection: "resume" },
  { key: "resumeWindowHours", type: "int", default: 48, min: 1, max: 8760, configKey: "indexingResumeMaxAgeHours", envKey: "INDEXING_RESUME_MAX_AGE_HOURS", group: "runtime", uiCategory: "flow", uiSection: "resume" },
  ...
  { key: "s3Bucket", type: "string", default: "my-spec-harvester-data", readOnly: true, configKey: "s3Bucket", envKey: "S3_BUCKET", group: "storage", uiCategory: "flow", uiSection: "cloud" },
  { key: "s3InputPrefix", type: "string", default: "specs/inputs", allowEmpty: true, configKey: "s3InputPrefix", envKey: "S3_INPUT_PREFIX", group: "storage", uiCategory: "flow", uiSection: "cloud" },
  { key: "s3OutputPrefix", type: "string", default: "specs/outputs", allowEmpty: true, configKey: "s3OutputPrefix", envKey: "S3_OUTPUT_PREFIX", group: "storage", uiCategory: "flow", uiSection: "cloud" },
  { key: "searchEngines", type: "csv_enum", default: "google", allowed: SEARXNG_AVAILABLE_ENGINES, aliases: ["searchProvider"], configKey: "searchEngines", envKey: "SEARCH_ENGINES", group: "misc", uiCategory: "planner", uiSection: "engines" },
  { key: "searchEnginesFallback", type: "csv_enum", default: "bing", allowed: SEARXNG_AVAILABLE_ENGINES, configKey: "searchEnginesFallback", envKey: "SEARCH_ENGINES_FALLBACK", group: "misc", uiCategory: "planner", uiSection: "engines" },
  { key: "searchMaxRetries", type: "int", default: 3, min: 0, max: 5, configKey: "searchMaxRetries", envKey: "SEARCH_MAX_RETRIES", group: "misc", uiCategory: "planner", uiSection: "engines" },
  ...
  { key: "searxngBaseUrl", type: "string", default: "http://127.0.0.1:8080", allowEmpty: true, configKey: "searxngBaseUrl", envKey: "SEARXNG_BASE_URL", group: "discovery", uiCategory: "planner", uiSection: "engines" },
  { key: "searxngMinQueryIntervalMs", type: "int", default: 3000, min: 0, max: 30000, configKey: "searxngMinQueryIntervalMs", envKey: "SEARXNG_MIN_QUERY_INTERVAL_MS", group: "misc", uiCategory: "planner", uiSection: "engines" },
  { key: "specDbDir", type: "string", default: ".specfactory_tmp", allowEmpty: true, configKey: "specDbDir", envKey: "SPEC_DB_DIR", group: "paths", uiCategory: "flow", uiSection: "storage" },
