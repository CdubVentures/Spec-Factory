...
export const RUNTIME_SETTINGS_REGISTRY = Object.freeze([
  ...
  { key: "crawlSessionCount", type: "int", default: 4, min: 1, max: 20, configKey: "crawlSessionCount", envKey: "CRAWL_SESSION_COUNT", group: "misc", uiCategory: "fetcher", uiSection: "network", uiHero: true },
  ...
  { key: "frontierBackoffMaxExponent", type: "int", default: 4, min: 1, max: 12, configKey: "frontierBackoffMaxExponent", envKey: "FRONTIER_BACKOFF_MAX_EXPONENT", group: "paths", uiCategory: "fetcher", uiSection: "network" },
  { key: "frontierBlockedDomainThreshold", type: "int", default: 1, min: 1, max: 50, configKey: "frontierBlockedDomainThreshold", envKey: "FRONTIER_BLOCKED_DOMAIN_THRESHOLD", group: "paths", uiCategory: "fetcher", uiSection: "network" },
  { key: "frontierCooldown403BaseSeconds", type: "int", default: 1800, min: 0, max: 86400, configKey: "frontierCooldown403BaseSeconds", envKey: "FRONTIER_COOLDOWN_403_BASE", group: "paths", uiCategory: "fetcher", uiSection: "network" },
  { key: "frontierCooldown404RepeatSeconds", type: "int", default: 1209600, min: 0, max: 31536000, configKey: "frontierCooldown404RepeatSeconds", envKey: "FRONTIER_COOLDOWN_404_REPEAT", group: "paths", uiCategory: "fetcher", uiSection: "network" },
  { key: "frontierCooldown404Seconds", type: "int", default: 259200, min: 0, max: 31536000, configKey: "frontierCooldown404Seconds", envKey: "FRONTIER_COOLDOWN_404", group: "paths", uiCategory: "fetcher", uiSection: "network" },
  { key: "frontierCooldown410Seconds", type: "int", default: 7776000, min: 0, max: 31536000, configKey: "frontierCooldown410Seconds", envKey: "FRONTIER_COOLDOWN_410", group: "paths", uiCategory: "fetcher", uiSection: "network" },
  { key: "frontierCooldown429BaseSeconds", type: "int", default: 600, min: 0, max: 86400, configKey: "frontierCooldown429BaseSeconds", envKey: "FRONTIER_COOLDOWN_429_BASE", group: "paths", uiCategory: "fetcher", uiSection: "network" },
  { key: "frontierCooldownTimeoutSeconds", type: "int", default: 21600, min: 0, max: 31536000, configKey: "frontierCooldownTimeoutSeconds", envKey: "FRONTIER_COOLDOWN_TIMEOUT", group: "paths", uiCategory: "fetcher", uiSection: "network" },
  { key: "frontierDbPath", type: "string", default: "_intel/frontier/frontier.json", allowEmpty: true, configKey: "frontierDbPath", envKey: "FRONTIER_DB_PATH", group: "paths", uiCategory: "fetcher", uiSection: "network" },
  { key: "frontierPathPenaltyNotfoundThreshold", type: "int", default: 3, min: 1, max: 50, configKey: "frontierPathPenaltyNotfoundThreshold", envKey: "FRONTIER_PATH_PENALTY_NOTFOUND_THRESHOLD", group: "paths", uiCategory: "fetcher", uiSection: "network" },
  { key: "frontierQueryCooldownSeconds", type: "int", default: 21600, min: 0, max: 31536000, configKey: "frontierQueryCooldownSeconds", envKey: "FRONTIER_QUERY_COOLDOWN_SECONDS", group: "paths", uiCategory: "fetcher", uiSection: "network" },
  { key: "frontierStripTrackingParams", type: "bool", default: true, configKey: "frontierStripTrackingParams", envKey: "FRONTIER_STRIP_TRACKING_PARAMS", group: "paths", uiCategory: "fetcher", uiSection: "network" },
  ...
  { key: "pageGotoTimeoutMs", type: "int", default: 12000, min: 0, max: 120000, configKey: "pageGotoTimeoutMs", envKey: "PAGE_GOTO_TIMEOUT_MS", group: "misc", uiCategory: "fetcher", uiSection: "network" },
  { key: "pageNetworkIdleTimeoutMs", type: "int", default: 2000, min: 0, max: 60000, configKey: "pageNetworkIdleTimeoutMs", envKey: "PAGE_NETWORK_IDLE_TIMEOUT_MS", group: "misc", uiCategory: "fetcher", uiSection: "network" },
  { key: "perHostMinDelayMs", type: "int", default: 1500, min: 0, max: 120000, configKey: "perHostMinDelayMs", envKey: "PER_HOST_MIN_DELAY_MS", group: "misc", uiCategory: "fetcher", uiSection: "network" },
  ...
  { key: "postLoadWaitMs", type: "int", default: 200, min: 0, max: 60000, configKey: "postLoadWaitMs", envKey: "POST_LOAD_WAIT_MS", group: "misc", uiCategory: "fetcher", uiSection: "network" },
