...
export const RUNTIME_SETTINGS_REGISTRY = Object.freeze([
  ...
  { key: "fetcherAdapter", type: "enum", default: "crawlee", allowed: ["crawlee"], configKey: "fetcherAdapter", envKey: "FETCHER_ADAPTER", group: "runtime", uiCategory: "fetcher", uiSection: "browser", uiHero: true },
  { key: "fetcherPlugins", type: "string", default: "stealth,autoScroll,screenshot", configKey: "fetcherPlugins", envKey: "FETCHER_PLUGINS", group: "runtime", uiCategory: "fetcher", uiSection: "browser" },
  ...
  { key: "specDbDir", type: "string", default: ".specfactory_tmp", allowEmpty: true, configKey: "specDbDir", envKey: "SPEC_DB_DIR", group: "paths", uiCategory: "flow", uiSection: "output" },
